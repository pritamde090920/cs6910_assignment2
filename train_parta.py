import wandb
from Part_A.RunTrainPartA import Train
import warnings
...
def main():
    ...
    wandb.run.name=run
    Train.runTrain(project_name,epochs,batch_size,numOfFilters,sizeFilter,sizeDenseUnits,batchNormalization,dataAugmentation,dropoutProb,activation,filterOrganization,test)
    wandb.finish()

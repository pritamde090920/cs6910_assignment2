...
def main():
    ...
    wandb.run.name=run
    Train.runTrain(epochs,batch_size,numOfFilters,sizeFilter,sizeDenseUnits,batchNormalization,dataAugmentation,dropoutProb,activation,filterOrganization,test)
    wandb.finish()
